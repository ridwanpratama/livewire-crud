...
## General info
This project is simple crud using Livewire in Laravel.
...
1. Clone this project `https://github.com/ridwanz02/livewire-crud.git`
2. Go to project folder `cd livewire-crud`
